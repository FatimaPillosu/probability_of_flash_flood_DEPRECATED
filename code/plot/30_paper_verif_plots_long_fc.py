      ...
      for loss_func in loss_func_list:
            ...
            for eval_metric in eval_metric_list:
                  ...
                  for step_f in range(step_f_start, step_f_final + 1, 24):
                        ...
                        plt.xlabel("False Alarm Rate", color = "#333333", fontsize = 28, labelpad = 10)
                        ...
                        plt.xlabel("Forecast probability", color = "#333333", fontsize = 28, labelpad = 10)
                  ...
                  plt.xlabel("Lead time (hours)", color = "#333333", fontsize = 28, labelpad = 10)
